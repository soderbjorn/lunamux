 ...
 * commonMain (`LayoutPreset.computeBoxes`), so termtastic and notegrow
 ...
 * toolkit's `LayoutBox` rectangles into termtastic's [PaneBox] type
 ...
 * same 5% grid termtastic's drag-to-move/resize gestures already
...
/** Convert the toolkit's normalized rectangle to termtastic's. */
