/**
 * Tree overview screen for the Lunamux Android app.
 *
...
import se.soderbjorn.lunamux.client.addPaneToTab
import se.soderbjorn.lunamux.client.addTab
import se.soderbjorn.lunamux.client.closePane
...
import se.soderbjorn.lunamux.client.setTabHidden
import se.soderbjorn.lunamux.client.setTabHiddenFromSidebar
import se.soderbjorn.lunamux.client.viewmodel.HttpSettingsPersister
...
private sealed class TreeRow {
     ...
     *   strip ([se.soderbjorn.lunamux.TabConfig.isHidden]). Labels the tab
