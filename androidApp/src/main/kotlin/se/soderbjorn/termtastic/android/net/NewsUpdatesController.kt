 ...
 * app-wide [se.soderbjorn.termtastic.client.storage.LocalRepository] (via
 ...
 * ([se.soderbjorn.termtastic.android.ui.NewsUpdatesScreen]) renders and mutates
 * it (download + swipe-to-dismiss).
 *
 * @see se.soderbjorn.termtastic.client.newsupdates.NewsUpdatesBackingViewModel
 * @see se.soderbjorn.termtastic.android.ui.NewsUpdatesScreen
 */
