...
object ConnectionHolder {
     ...
     *
     * Called from [se.soderbjorn.termtastic.android.ui.TermtasticApp]'s
     ...
     * thrown by [se.soderbjorn.termtastic.client.createPinnedHttpClient] when
     * the server's leaf cert no longer matches the stored pin. Used by
     * [se.soderbjorn.termtastic.android.ui.HostsScreen] to decide between
