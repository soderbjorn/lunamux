/**
 * Inline rename handler for tab labels in the Lunamux web frontend.
 *
 * Pane title rename is handled by the toolkit: Lunamux supplies
 ...
 * menu in `lunamuxPaneActions` exposes a "Rename pane" item that
 ...
 * Lunamux supplies the double-click trigger itself —
 ...
 * so Lunamux hand-rolls the inline rename here, mirroring
