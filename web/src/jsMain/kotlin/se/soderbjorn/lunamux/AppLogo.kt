/**
 * App logo widget for the Lunamux web frontend.
 *
 * Renders the "Lunamux" wordmark and a small status dot pinned to the top
 * of the left (sessions) sidebar — see `LunamuxToolkitBootstrap.buildSidebarLogo`,
 ...
 * styles.css.
 *
 * The logo brings back an older design element (see issue #14): a "Lunamux"
