/**
 * "News & Updates" modal for the Lunamux desktop (Electron) renderer.
 *
 * Opened from the top-bar bell action (`tt-topbar-news`, built in
 * `LunamuxToolkitBootstrap`; the bell is always visible but rendered muted
 ...
 * @see se.soderbjorn.lunamux.client.newsupdates.NewsUpdatesBackingViewModel.dismissNews
 * @see se.soderbjorn.lunamux.client.newsupdates.NewsUpdatesBackingViewModel.dismissUpdate
 * @see se.soderbjorn.lunamux.client.newsupdates.NewsUpdatesBackingViewModel.restoreAll
 */
