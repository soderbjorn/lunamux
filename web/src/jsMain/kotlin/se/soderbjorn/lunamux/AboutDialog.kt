/**
 * About dialog for the Lunamux web frontend.
 *
 ...
 * texts" pointer. Derived from the shared [LUNAMUX_GITHUB_URL] so the repository
 * slug stays in lockstep with every other client's GitHub link.
 */
private const val NOTICE_URL = "$LUNAMUX_GITHUB_URL/blob/main/NOTICE"

/**
 * Third-party libraries used by Lunamux across all platforms
 ...
 * machine's LAN address, and the website link.
 *
