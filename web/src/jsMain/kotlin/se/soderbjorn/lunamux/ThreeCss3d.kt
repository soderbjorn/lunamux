 ...
 *
 * The core WebGL renderer ([se.soderbjorn.lunamux.three.WebGLRenderer])
 * draws textured planes — snapshots of terminals, not interactive ones. The
 * Phase-2 world-mode spike ([se.soderbjorn.lunamux.World3DSpike]) needs the
 ...
 * minimal, in the spirit of [se.soderbjorn.lunamux.three] — only the surface
 * the spike calls.
 *
 * @see se.soderbjorn.lunamux.three.WebGLRenderer
 * @see se.soderbjorn.lunamux.World3DSpike
 */
