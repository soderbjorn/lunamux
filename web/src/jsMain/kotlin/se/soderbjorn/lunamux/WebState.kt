/**
 * Top-level singletons for the Lunamux web frontend: the
 * [LunamuxClient], the `/window` [WindowSocket], the
 ...
 * top-level in `se.soderbjorn.lunamux`, so consumers continue to
...
internal lateinit var lunamuxClient: LunamuxClient
 ...
 * the in-process [se.soderbjorn.lunamux.client.demo.DemoServer]: no
