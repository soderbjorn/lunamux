/**
 * Centralised SVG glyphs for the four termtastic pane kinds (terminal,
...
/**
 * Looks up the icon SVG for a given termtastic leaf, by its dynamic
 ...
 */
fun termtasticPaneIcon(leaf: dynamic): String? {
