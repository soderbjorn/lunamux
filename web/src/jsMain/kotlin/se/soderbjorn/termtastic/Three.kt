 ...
 * collide with app types in `se.soderbjorn.termtastic`.
 *
 * @see se.soderbjorn.termtastic.toggleOverview3d
 */
@file:JsModule("three")
@file:JsNonModule
 ...
 * the existing 2D thumbnail renderer ([se.soderbjorn.termtastic.renderThumbnail])
