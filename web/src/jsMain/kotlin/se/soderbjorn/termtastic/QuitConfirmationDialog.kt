/**
 * Quit-confirmation dialog for the Termtastic Electron host.
 *
 ...
 * background server — needed only when installing a new Termtastic
 ...
 * appearance with other Termtastic dialogs (close-pane confirmation,
...
fun showQuitConfirmationDialog(onResult: (QuitConfirmationResult) -> Unit) {
    ...
    title.textContent = "Quit Termtastic?"
