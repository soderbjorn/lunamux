/**
 * Android `actual` implementation of [secureRandomBytes].
 *
 * Uses [java.security.SecureRandom] to generate cryptographically strong
 * random bytes for device-auth token creation.
 *
...
/**
 * Generate [n] cryptographically strong random bytes using Android's
 * [SecureRandom].
 *
