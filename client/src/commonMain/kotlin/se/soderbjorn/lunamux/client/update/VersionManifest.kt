 ...
 * single `versions.json` published on the main website (`lunamux.dev`)
 ...
 * `lunamux.dev/versions.json`) and live in the shared `client` module so all
 * three platforms parse the same shape — the comparison and notification logic
 * in [se.soderbjorn.lunamux.client.newsupdates.NewsUpdatesBackingViewModel]
 ...
 * [se.soderbjorn.lunamux.client.newsupdates.NewsUpdatesBackingViewModel] so
