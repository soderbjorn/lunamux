 ...
 *
 * Unlike [se.soderbjorn.lunamux.client.createPinnedHttpClient], which talks
 * to the user's self-signed Lunamux server and enforces TOFU certificate
 * pinning, the update checker fetches `versions.json` from
 * `lunamux.dev` — a public host with a normal CA-issued
 ...
 * JS), mirroring the [se.soderbjorn.lunamux.client.PinnedHttpClientFactory]
 ...
 *   [se.soderbjorn.lunamux.client.newsupdates.NewsUpdatesBackingViewModel]
