/**
 * Device-authentication token generation, encoding, and storage for Lunamux.
 *
 * Every Lunamux client (web, Android, iOS, desktop) identifies itself to the
 ...
 * on every request to the server — see [LunamuxClient] for how the client
 * attaches it.
 */
