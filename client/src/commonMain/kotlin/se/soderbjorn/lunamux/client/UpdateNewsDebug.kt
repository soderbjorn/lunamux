 ...
 *
 *  - [USE_SAMPLE_DATA] makes [se.soderbjorn.lunamux.client.newsupdates.NewsUpdatesBackingViewModel]
 ...
 * GitHub, check at most once per [se.soderbjorn.lunamux.client.newsupdates.CHECK_INTERVAL_MILLIS]).
...
import se.soderbjorn.lunamux.client.update.PlatformVersionInfo
 ...
 * [se.soderbjorn.lunamux.client.newsupdates.NewsUpdatesBackingViewModel.checkNow]
...
val SAMPLE_VERSION_MANIFEST: VersionManifest = VersionManifest(
    ...
    platforms = mapOf(
        UpdatePlatform.ANDROID to PlatformVersionInfo(
            ...
            url = "https://lunamux.dev/#/download",
        ),
