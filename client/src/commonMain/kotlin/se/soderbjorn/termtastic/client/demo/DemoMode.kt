 ...
 * A [se.soderbjorn.termtastic.client.TermtasticClient] constructed for that
 * host runs entirely against the in-process [DemoServer] simulation and
 * never makes a network call.
 *
 * @see DemoServer
 * @see se.soderbjorn.termtastic.client.TermtasticClient.demoMode
 */
 ...
 *
 * Called by [se.soderbjorn.termtastic.client.TermtasticClient] at
