 ...
 *   - [RealWindowSocket] talks WebSocket to a live Termtastic server
 *     (created via [TermtasticClient.openWindowSocket]);
 *   - [se.soderbjorn.termtastic.client.demo.DemoWindowSocket] answers from
 *     the in-process [se.soderbjorn.termtastic.client.demo.DemoServer]
 ...
 * [se.soderbjorn.termtastic.client.demo.DemoWindowSocket] (in-process
 * simulation).
 */
