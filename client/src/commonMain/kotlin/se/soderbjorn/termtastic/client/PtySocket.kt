 ...
 *     (created via [TermtasticClient.openPtySocket]);
 *   - [se.soderbjorn.termtastic.client.demo.DemoPtySocket] streams canned
 *     scrollback and simulated command responses from the in-process
 *     [se.soderbjorn.termtastic.client.demo.DemoServer] (demo mode).
 *
 ...
 * [se.soderbjorn.termtastic.client.demo.DemoPtySocket] (in-process
 * simulation).
 */
interface PtySocket {
