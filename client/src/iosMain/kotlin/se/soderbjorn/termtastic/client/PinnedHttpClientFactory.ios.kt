 ...
 *    [TermtasticClient]) to tell a pin mismatch apart from any other
 *    connection failure.
 *
 ...
 * `src/nativeInterop/cinterop/termtasticTls.def`. See the shim's KDoc for
...
import se.soderbjorn.termtastic.client.tlsinterop.termtastic_credential_for_trust
import se.soderbjorn.termtastic.client.tlsinterop.termtastic_disposition_cancel
import se.soderbjorn.termtastic.client.tlsinterop.termtastic_disposition_perform_default
import se.soderbjorn.termtastic.client.tlsinterop.termtastic_disposition_use_credential
import se.soderbjorn.termtastic.client.tlsinterop.termtastic_server_trust
