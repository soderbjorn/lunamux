...
actual class SecureStore {
    ...
    // KEEP the original service id across the Termtastic→Lunamux rename:
    // existing devices hold their auth token under this Keychain service, and
    // renaming it would orphan the token (forcing re-approval on upgrade).
