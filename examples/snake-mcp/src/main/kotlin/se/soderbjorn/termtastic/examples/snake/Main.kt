 ...
 * ```
 *
 * Then bring the "Snake" pane into view in any Termtastic client and
...
fun main(args: Array<String>) {
    ...
    driver.open()
    println("snake-mcp: console open (window ${driver.windowId}) — play with the arrow keys in Termtastic; q quits.")
